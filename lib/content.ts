...
└────────┬─────────┘    └───────────────────┘
   ...
   reply to customer ──▶ log to CRM`,
    ...
    repo: "https://github.com/imanaswer/AI-Customer-Support-Agent",
    year: "2026",
    status: "shipped",
  },
  {
    ...
    repo: "https://github.com/imanaswer/Stripe-style-Event-Processing-Platform",
    year: "2026",
    status: "shipped",
  },
  {
...
question ──▶ embed ──▶ top-k ──▶ rerank ──┘
    ...
    repo: "https://github.com/imanaswer/Internal-AI-chatbot",
    year: "2026",
    status: "shipped",
  },
  {
...
query ──▶ graph traversal + vector search
  ...
  },
  {
    ...
    stack: ["Go"],
    repo: "https://github.com/imanaswer/kafka",
    year: "2025",
    status: "shipped",
  },
];
